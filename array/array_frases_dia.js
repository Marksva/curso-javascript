// exemplo usando array de frases, uma frase para cada dia do mês. 
...
var data_atual = new Date(); // retorna a data completa dia, mes, hora.
var numero_escolhido = data_atual.getDate(); // captura somente o dia do mês.    

console.log("Número sorteado: " + numero_escolhido);
numero_escolhido--; // precisamos fazer o decremento, por causa do indice do array. ou seja o dia 1 do mês corresponde ao indice 0 do array. 
